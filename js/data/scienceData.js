...
const SKELETON_BONES = [
  { id: "skull", name: "Skull (Cranium)", category: "Head", targetX: 200, targetY: 45, width: 60, height: 60, icon: "💀", desc: "The hard bony helmet that protects your brain, eyes, and inner ears.", fact: "Your skull is actually made of 22 interlocking cranial and facial bones!", joint: "Fixed (Fibrous Sutures)" },
  { id: "spine", name: "Spine (Vertebrae)", category: "Torso", targetX: 200, targetY: 130, width: 30, height: 80, icon: "🦴", desc: "The flexible central column that supports your body and protects the spinal cord.", fact: "You have 33 vertebrae in your spine that act like shock absorbers.", joint: "Cartilaginous (Slightly Movable)" },
  { id: "ribs", name: "Rib Cage", category: "Torso", targetX: 200, targetY: 110, width: 75, height: 65, icon: "🫁", desc: "The protective cage of 12 pairs of curved bones shielding your heart and lungs.", fact: "Your ribs expand and contract every time you breathe in oxygen.", joint: "Cartilage Joints" },
  { id: "pelvis", name: "Pelvis (Hip Bone)", category: "Hips", targetX: 200, targetY: 185, width: 75, height: 45, icon: "🩻", desc: "The basin-shaped bone connecting your spine to your legs and supporting organs.", fact: "The pelvis absorbs the impact forces when you run, jump, or land.", joint: "Ball-and-Socket (Hip Joint)" },
  { id: "humerus_l", name: "Humerus (Upper Arm)", category: "Arm", targetX: 145, targetY: 120, width: 25, height: 50, icon: "💪", desc: "The long bone connecting your shoulder blade to your elbow joint.", fact: "It's called the humerus, which is why hitting your elbow nerve is the 'funny bone'!", joint: "Ball-and-Socket (Shoulder) / Hinge (Elbow)" },
  { id: "humerus_r", name: "Humerus (Right Arm)", category: "Arm", targetX: 255, targetY: 120, width: 25, height: 50, icon: "💪", desc: "Connects the right shoulder to the elbow.", fact: "Works together with the biceps and triceps muscles to lift objects.", joint: "Ball-and-Socket / Hinge" },
  { id: "forearm_l", name: "Radius & Ulna (Forearm)", category: "Arm", targetX: 135, targetY: 175, width: 25, height: 50, icon: "🖐️", desc: "The two parallel bones in your forearm that twist over each other to turn your palm.", fact: "The radius is on the thumb side; the ulna is on the pinky side.", joint: "Pivot Joint (Allows wrist rotation)" },
  { id: "forearm_r", name: "Radius & Ulna (Right Forearm)", category: "Arm", targetX: 265, targetY: 175, width: 25, height: 50, icon: "🖐️", desc: "Allows forearm twisting and wrist connection.", fact: "Pivot joint allows complete 180-degree palm flipping.", joint: "Pivot Joint" },
  { id: "femur_l", name: "Femur (Left Thigh)", category: "Leg", targetX: 175, targetY: 245, width: 30, height: 65, icon: "🦵", desc: "The longest, heaviest, and strongest bone in the entire human body!", fact: "The femur can support up to 30 times the weight of an adult human body.", joint: "Ball-and-Socket (Hip) / Hinge (Knee)" },
  { id: "femur_r", name: "Femur (Right Thigh)", category: "Leg", targetX: 225, targetY: 245, width: 30, height: 65, icon: "🦵", desc: "Connects the right hip to the right knee.", fact: "Carries your weight with every stride when running.", joint: "Ball-and-Socket / Hinge" },
  { id: "tibia_l", name: "Tibia & Fibula (Left Shin)", category: "Leg", targetX: 175, targetY: 315, width: 30, height: 65, icon: "👟", desc: "The tibia (shinbone) bears your weight while the slender fibula stabilizes the ankle.", fact: "The tibia is the second longest bone in the body after the femur.", joint: "Hinge (Knee) / Gliding (Ankle)" },
  { id: "tibia_r", name: "Tibia & Fibula (Right Shin)", category: "Leg", targetX: 225, targetY: 315, width: 30, height: 65, icon: "👟", desc: "Connects the right knee to the foot.", fact: "Provides the anchor point for your calf jumping muscles.", joint: "Hinge / Gliding" }
];
